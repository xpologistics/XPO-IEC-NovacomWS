    ...
    private void createGPSMessage(final AssetData assetData) throws InternalException {
        try {
            ...
            if (immat != null) {
                ...
                if (vehicule == null) {
                    log.error("Venum nom trouv� pour immat : " + immat);
                    log.error("Flux d'entr�� : " + assetData.toString());
                } else {
                    ...
                    //Si ce n'est pas encore un equipement embarqu� IEC on demande un ajout
                    log.debug("V�rification dans si immat dans IEC");
